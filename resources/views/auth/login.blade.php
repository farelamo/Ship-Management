        ...
        <section class="section">
            <div class="d-flex align-items-stretch flex-wrap">
                <div class="col-lg-4 col-md-6 col-12 order-lg-1 min-vh-100 order-2 bg-white">
                    <div class="m-3 p-4">
                        <img src="{{ asset('img/ssm-yellow.png') }}"
                            alt="logo"
                            width="100"
                            class="mb-2 mt-2 center-block">
                        <h4 class="text-dark font-weight-normal">Welcome to <span class="font-weight-bold">Sea Soft Management</span>
                        </h4>
                        ...
                        <div class="text-small mt-5 text-center">
                            Copyright &copy; Sea Soft Management. Made with 💙 by Developer
                            <div class="mt-2">
                ...
                <div class="col-lg-8 col-12 order-lg-2 min-vh-100 background-walk-x position-relative overlay-gradient-bottom order-1"
                    ...
                    <div class="absolute-bottom-left index-2">
                        <div class="text-light p-5 pb-2">
                            ...
                            Photo by <a class="text-light bb"
                                target="_blank"
                                href="https://unsplash.com">Unsplash</a> on <a
                                class="text-light bb"
                                target="_blank"
